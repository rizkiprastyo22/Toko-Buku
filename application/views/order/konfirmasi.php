    ...
    <div class="card">
      ...
      <div class="card-content">
        <form class="row" id="add-promo-form" method="post" action="" enctype="multipart/form-data">
          ...
          <div class="input-field col s12 m6">
              <input id="judul" readonly name="judul" type="text" value="<?php echo $order->judul; ?>">
              <label for="judul" class="">Judul Buku</label>
          </div>
          <div class="input-field col s12 m6">
              <input id="nama" readonly name="nama" type="text" value="<?php echo $order->nama; ?>">
          ...
          <div class="input-field col s6 m6 l6 right-align">
            <br><br><button type="submit" name="submit-konfirmasi" value="add_konfirmasi" class="btn purple lighten-2 waves-effect waves-green">Kirim Sekarang</button>
          </div>
        </form>
        <!-- Modal Structure -->
        <div id="modal3" class="modal center-align" style="width:320px;">
          ...
          <div class="modal-footer">
            <a href="<?php echo base_url('order'); ?>" class="modal-close waves-effect waves-green btn-flat">Yakin</a>
