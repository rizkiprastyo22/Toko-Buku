                  ...
                  <?php $no = 0; foreach($keranjang as $row): 
                    ...
                    <tr>
                      ...
                      <td class="center-align">
                        <a href="<?php echo base_url('keranjang/edit/' . $row->id); ?>" class="btn-floating halfway-fab waves-effect waves-light tooltipped purple lighten-2" data-position="top" data-tooltip="Edit Data"><i class="material-icons">edit</i></a>
                        ...
                        <div id="modal1" class="modal">
                          ...
                          <div class="modal-footer">
                            <a href="<?php echo base_url('keranjang/delete/' . $row->id); ?>" class="modal-close waves-effect waves-green btn-flat">Yakin</a>
